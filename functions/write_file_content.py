...
schema_write_file_content = types.FunctionDeclaration(
    ...
    description="Writes (or overwrites) content to a file within the working directory. Use this only to alter or add content—do not use for reading or retrieving content.",
